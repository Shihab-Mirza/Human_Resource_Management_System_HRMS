                    ...
                    <form class="employee-form" action="{{ url('submit_new_employee_form') }}" method="post">
                        ...
                        <fieldset class="personal-info-fieldset">
                            ...
                            <div class="personal-info-inline-group">
                                <div class="first-name-field" style="flex: 1; margin-right: 10px;">
                                    ...
                                    <input type="text" id="first-name" name="first_name" class="first-name-input" required>
                                </div>
                                <div class="last-name-field" style="flex: 1;">
                                    <label for="last-name" class="last-name-label">Last Name:</label>
                                    <input type="text" id="last-name" name="last_name" class="last-name-input" required>
                                </div>
                            </div>
                            <div class="dob-field">
                                <label for="dob" class="dob-label">Date of Birth:</label>
                                <input type="date" id="dob" name="dob" class="dob-input" required>
                            </div>
                        ...
                        <fieldset class="contact-info-fieldset">
                            ...
                            <div class="email-field">
                                ...
                                <input type="email" id="email" name="employee_email" class="email-input" required>
                            </div>
                            ...
                            <div class="state-field">
                                <label for="state" class="state-label">Country:</label>
                                <input type="text" id="state" name="country" class="state-input" required>
                            </div>
                        </fieldset>
                        ...
                        <fieldset class="employment-info-fieldset">
                            ...
                            <div class="position-field">
                                ...
                                <input type="text" id="position" name="position" class="position-input" required>
                            </div>
